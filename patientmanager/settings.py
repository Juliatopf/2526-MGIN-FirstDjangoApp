...
SECRET_KEY = os.environ.get("SECRET_KEY", default='django-insecure-_3#@d1mugb5$p0jc=_mb%3pi(s^!z(mam=o_1638$wxh)dj%mq')
...
AUTH_USER_MODEL = 'Patientapp.models.Patient'